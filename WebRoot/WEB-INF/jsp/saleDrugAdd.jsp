...
<html>
  ...
  <body >
    ...
    <div id="subMenu">
    	<h1 style="color:red">售药添加页面</h1>
		 <form action="<%=basePath%>/saleDrug/saleDrugAdd.do"  method="post" onsubmit="return myclick()">
				<div id="addBackground4">
					顾客号&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="customer_id"><br />
				</div>
				<div id="addBackground5">
		    	药品编码&nbsp;&nbsp;&nbsp;<input type="text" name="drug_id"><br />
		    	</div>
		    	<div id="addBackground6" >
		    	销售量&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="sale_number"><br />
		    	</div>
		    	<div id="addBackground1" >
		    	销售日期&nbsp;&nbsp;&nbsp;<input name="date" class="Wdate" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})" />
		    	</div>
