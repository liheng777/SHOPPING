...
<html>
  ...
  <body >
    ...
    <div id="subMenu">
    	<h1 style="color:red">进药添加页面</h1>
		 <form action="<%=basePath%>/stockDrug/stockDrugAdd.do"  method="post" onsubmit="return myclick()">
			<div id="addBackground4">
				单据号&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="bill_id"><br />
			</div>
			<div id="addBackground5">
	    	药品编码&nbsp;&nbsp;&nbsp;<input type="text" name="drug_id"><br />
	    	</div>
	    	<div id="addBackground6" >
	    	采购价&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="price"><br />
	    	</div>
	    	<div id="addBackground1" >
	    	采购数量&nbsp;&nbsp;&nbsp;<input type="text" name="buy_num"><br />
	    	</div>
	    	<div id="addBackground2" >
	    	采购日期&nbsp;&nbsp;&nbsp;<input  name="date" class="Wdate" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})"/>
	    	</div>
	    	<div id="addBackground3" >
	    	供应商&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name=supplier><br />
	    	</div>
	    	<input type="submit" value="增加" onclick="my()" id="addBox" style="width: 240px">
	    </form>
	</div>
  </body>
</html>
